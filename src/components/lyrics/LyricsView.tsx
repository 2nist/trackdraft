...
export default function LyricsView() {
  const { currentSong, addSection, updateSection, deleteSection } =
    useSongStore();
    ...
    <div className="max-w-7xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-400">
          Step 5: Write your lyrics with distraction-free editing
        </p>
      </div>
                ...
                {showAddMenu && (
                  <div className="absolute right-0 top-full mt-2 w-48 bg-dark-elevated border border-gray-800 rounded-lg shadow-xl z-10">
                    <div className="p-2 space-y-1">
                      {(
                        ["intro", "verse", "chorus", "bridge", "outro"] as const
                      ).map((type) => (
                        <button
                          key={type}
                          onClick={() => {
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center justify-between mb-1">
                        <span
                          className={`text-xs font-semibold px-2 py-0.5 rounded ${getSectionColor(
                            section.type
                          )}`}
                        >
                ...
                <div className="flex items-center justify-between mb-4">
                  <div>
                    ...
                    <p className="text-sm text-gray-400">
                      {selectedSection.narrativePurpose ||
          ...
          <div className="card sticky top-6">
            ...
            <div className="space-y-4 text-sm text-gray-400">
              <div>
                ...
                <p>
                  Disables editing to keep you writing forward. Perfect for
                  first drafts.
                </p>
              </div>
              <div>
                ...
                <p>
                  Write your draft first, then unlock editing. Prevents
              ...
              <div>
                ...
                <p>
                  Shows only the current line. Helps maintain flow and rhythm.
                </p>
              </div>
              <div>
                <p className="text-white font-medium mb-1">Syllable Matching</p>
                <p>
                  Use the target rhythm feature to match verse lines to your
                  chorus rhythm.
                </p>
              </div>
            </div>
