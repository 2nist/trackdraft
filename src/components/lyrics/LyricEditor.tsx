...
export default function LyricEditor({
  ...
  useEffect(() => {
    if (mode === "focus" && textareaRef.current) {
      const lineStart = value.substring(
        0,
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-2 border-b border-gray-800 pb-4">
        {(["typewriter", "hemingway", "focus", "normal"] as EditorMode[]).map(
          (m) => {
      ...
      {mode === "hemingway" && !hemingwayComplete && (
        <div className="bg-yellow-500/20 border border-yellow-500/50 rounded-lg p-3">
          <p className="text-sm text-yellow-300 mb-2">
            ✍️ <strong>Hemingway Mode:</strong> Write your draft first. Editing
            is disabled until you mark it complete.
          </p>
          <button
      ...
      <div className="relative">
        ...
        <textarea
          ...
          style={{
            fontFamily:
              mode === "typewriter" ? "Courier New, monospace" : "inherit",
