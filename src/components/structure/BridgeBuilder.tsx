...
export default function BridgeBuilder() {
  ...
  const currentProgression = currentSong.sections
    ...
    .filter(
      (c, i, arr) =>
        arr.findIndex((c2) => c2.romanNumeral === c.romanNumeral) === i
    );

  const chordSuggestions = getBridgeChordSuggestions(
    currentSong.key,
    currentProgression
  );
    ...
    <div className="space-y-6">
      <div className="card">
        ...
        <p className="text-gray-400">
          Create contrast and interest in your bridge using these three
          strategies
        </p>
      </div>
          ...
          <div className="card">
            ...
            <div className="space-y-4">
              <div className="p-3 bg-dark-elevated rounded border border-gray-800">
                ...
                <div className="text-sm text-gray-400 mb-2">
                  <strong>Technique:</strong> Complete style change (opera
                  section)
                </div>
                <div className="text-xs text-gray-500">
                  The bridge completely shifts genre, creating maximum contrast
                  before returning to the rock section.
                </div>
              </div>
              <div className="p-3 bg-dark-elevated rounded border border-gray-800">
                <div className="font-semibold text-white mb-1">
                ...
                <div className="text-xs text-gray-500">
                  "And when the broken-hearted people..." - shifts to a new
                  perspective with emotional intensity.
                </div>
              </div>
              <div className="p-3 bg-dark-elevated rounded border border-gray-800">
                <div className="font-semibold text-white mb-1">
                ...
                <div className="text-sm text-gray-400 mb-2">
                  <strong>Technique:</strong> Harmonic departure + emotional
                  peak
                </div>
                <div className="text-xs text-gray-500">
                  Uses borrowed chords (bIII, bVI) to create emotional intensity
                  at the bridge.
                </div>
              </div>
              <div className="p-3 bg-dark-elevated rounded border border-gray-800">
                ...
                <div className="text-xs text-gray-500">
                  Shifts to 3/4 time and builds dynamically to the guitar solo
                  climax.
                </div>
              </div>
            </div>
          ...
          <div className="card border-2 border-purple-500/50">
            ...
            <div className="space-y-3">
              ...
              <div className="p-3 bg-purple-500/10 rounded border border-purple-500/30">
                ...
                <div className="text-sm text-gray-300">
                  "What if I was wrong?" or "Maybe I've been looking at this all
                  wrong..."
                </div>
              </div>
              <div className="p-3 bg-purple-500/10 rounded border border-purple-500/30">
